...
class PredictionResponse(BaseModel):
    ...
    prediction: int = Field(
        ..., description="Bankruptcy prediction (0: Not Bankrupt, 1: Bankrupt)"
    )
...
class BatchPredictionRequest(BaseModel):
    ...
    model_name: Optional[str] = Field(
        None, description="Specific model to use for all predictions"
    )
...
class ModelInfo(BaseModel):
    ...
    performance_metrics: ModelMetrics = Field(
    ...
    feature_importance: Optional[List[FeatureImportance]] = Field(
        None, description="Feature importance rankings"
    )
    training_data_size: Optional[int] = Field(
        None, description="Size of training dataset"
    )
