...
def main():
    ...
    parser = argparse.ArgumentParser(description='Optimized Bankruptcy Prediction Pipeline')
    
    parser.add_argument('--data', type=str, default='CompanyBankruptcyData.csv',
                       help='Path to the data file')
    parser.add_argument('--config', type=str, default=None,
                       help='Path to configuration JSON file')
    parser.add_argument('--optimize', action='store_true',
                       help='Enable advanced optimization')
    ...
    try:
        ...
        if args.optimize:
            ...
            for model_type in args.models:
                if model_type != 'neural_network':  # Skip NN for command line for simplicity
